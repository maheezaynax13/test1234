import { HandheldSecondaryLayout, HandheldServerError, MainLayout } from '@components/templates';
import { NextPage } from 'next';
import Link from 'next/link';
import { Col, Container, Image, Row } from 'react-bootstrap';

const ServerError: NextPage<PropsType> = (props) => {
	if (props.isMobile) {
		return (
			<HandheldSecondaryLayout title="Webpage not available">
				<HandheldServerError />
